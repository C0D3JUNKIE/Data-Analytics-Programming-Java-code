...
public class Poker5CardTest {
  ...
  @Test
  public void t18() {
    Card[] community = new Card[]{ new Card(Suit.HEART, Value.JACK), 
    		new Card(Suit.DIAMOND, Value.NINE), new Card(Suit.SPADE, Value.EIGHT)};
    Card[] p0 = new Card[]{ new Card(Suit.SPADE, Value.KING), new Card(Suit.HEART, Value.KING)};
    Card[] p1 = new Card[]{ new Card(Suit.CLUB, Value.ACE), new Card(Suit.CLUB, Value.TEN)};
    Card[][] players = new Card[2][];
    players[0] = p0;
    players[1] = p1;
    double[] result = Hand5Comparator.probabilities( community, players);
    assertEquals(0.6, result[0], 0.04);
  }
  
  @Test
  public void t19() {
    Card[] community = new Card[]{ new Card(Suit.DIAMOND, Value.SIX), 
    		new Card(Suit.DIAMOND, Value.JACK), new Card(Suit.CLUB, Value.QUEEN)};
    Card[] p0 = new Card[]{ new Card(Suit.DIAMOND, Value.SEVEN), new Card(Suit.DIAMOND, Value.FIVE)};
    Card[] p1 = new Card[]{ new Card(Suit.DIAMOND, Value.ACE), new Card(Suit.SPADE, Value.JACK)};
    Card[][] players = new Card[2][];
    players[0] = p0;
    players[1] = p1;
    double[] result = Hand5Comparator.probabilities( community, players);
    assertEquals(0.37, result[0], 0.03);
  }
  
  @Test
  public void t20() {
    Card[] community = new Card[]{ new Card(Suit.HEART, Value.EIGHT), 
    		new Card(Suit.SPADE, Value.ACE), new Card(Suit.CLUB, Value.EIGHT)};
    Card[] p0 = new Card[]{ new Card(Suit.SPADE, Value.KING), new Card(Suit.HEART, Value.JACK)};
    Card[] p1 = new Card[]{ new Card(Suit.CLUB, Value.TWO), new Card(Suit.CLUB, Value.FIVE)};
    Card[][] players = new Card[2][];
    players[0] = p0;
    players[1] = p1;
    double[] result = Hand5Comparator.probabilities( community, players);
    assertEquals(0.69, result[0], 0.05);
  }
}